                ...
                {testimonials.map(item => (
                    <div key={item._id} style={itemStyle}>
                        <div>
                            ...
                            <div style={{ fontSize: '0.8rem', opacity: 0.7 }}>{item.title}</div>
                        </div>
                        <div>
                            <button onClick={() => handleEdit(item)} style={{...iconBtnStyle, color: '#ae67fa'}}><FaEdit /></button>
                            <button onClick={() => handleDelete(item._id)} style={{...iconBtnStyle, color: '#FF4820'}}><FaTrash /></button>
                        </div>
                    </div>
                ))}
            </div>
