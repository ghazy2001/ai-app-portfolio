...
const BlogArticle = () => {
  ...
  if (loading)
    return (
      <div className="section__paddingWithNavbar">
        <Navbar />
  ...
  return (
    <div className="blog-article-page">
      ...
      <div
        className="section__padding blog-article-content"
        style={{ color: "white", minHeight: "60vh" }}
        dir="ltr"
      >
        <Link
          to="/blog"
        ...
        <p
          style={{ color: "#D4AF37", marginBottom: "2rem", fontSize: "1.2rem" }}
        >
