      ...
      <div className="MN__footer-links">
        ...
        <div className="MN__footer-col logo-col">
          ...
          <p className="footer-desc">
            We provide professional digital solutions tailored to your business
            needs, elevating your brand to the next level.
          </p>
        </div>
        ...
        <div className="MN__footer-col">
          ...
          <p>
            <a href="#features">Social Media</a>
          </p>
          <p>
            <a href="#features">Media Buying</a>
          </p>
          <p>
            <a href="#features">Branding</a>
          </p>
          <p>
            <a href="#features">Media Production</a>
          </p>
        </div>
        ...
        <div className="MN__footer-col contact-col">
          ...
          <div className="footer-socials">
            <a
              href="https://instagram.com/mn_marketingagency.eg"
              target="_blank"
              rel="noreferrer"
            >
              <RiInstagramLine />
            ...
            <a
              href="https://facebook.com/mnmarketing.eg"
              target="_blank"
              rel="noreferrer"
            >
              <RiFacebookCircleFill />
            ...
            <a
              href="https://linkedin.com/company/mnmarketingagency/"
              target="_blank"
              rel="noreferrer"
            >
              <RiLinkedinFill />
            ...
            <a
              href="https://tiktok.com/@mnmarketing.eg"
              target="_blank"
              rel="noreferrer"
            >
              <FaTiktok />
