...
import './contact.css';
import { RiWhatsappFill, RiInstagramLine, RiFacebookCircleFill, RiLinkedinFill } from 'react-icons/ri';
...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                setSuccess(true);
                setFormData({ name: "", email: "", message: "", phone: "", referral: "", interests: [] });
    ...
    return (
        <div className="MN__contact section__padding" id="contact">
            <div className="MN__contact-container">
                ...
                <div className="MN__contact-info">
                    ...
                    <div className="contact-details">
                        ...
                        <div className="contact-item">
                            <div className="icon-circle"><MdLocationOn /></div>
                            <div className="contact-text">
                    ...
                    <div className="contact-socials">
                        <a href="https://wa.me/..." target="_blank" rel="noreferrer"><RiWhatsappFill /></a>
                    ...
                    <form className="MN__contact-form" onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <div className="form-options-grid">
                                {["Brand Strategy", "Content Strategy", "Web Design", "App Development", "SEO & Marketing", "Media Production"].map(opt => (
                                    <div 
                                        key={opt} 
                        ...
                        <div className="form-group">
                            ...
                            <div className="budget-slider-container">
                                 <div className="budget-value-display">
                                    {selectedBudget ? Number(selectedBudget).toLocaleString() : '500'} EGP
                                 </div>
                                 <div className="range-wrapper">
                                     <input 
                                        ...
                                        style={{ backgroundSize: `${((selectedBudget - 500) * 100) / (50000 - 500)}% 100%` }}
                                     />
                                 </div>
                        ...
                        <div className="form-group">
                            <textarea name="message" rows="4" placeholder="Tell us about your project goals..." value={formData.message} onChange={handleInputChange} required></textarea>
                        </div>
